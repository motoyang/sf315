...
#define NLOG_INFO                                                               \
  nlog::inner::is_logged(nlog::LogLevel::INFO) && NANO_LOG(nlog::LogLevel::INFO)
#define NLOG_WARN                                                               \
  nlog::inner::is_logged(nlog::LogLevel::WARN) && NANO_LOG(nlog::LogLevel::WARN)
#define NLOG_CRIT                                                               \
  nlog::inner::is_logged(nlog::LogLevel::CRIT) && NANO_LOG(nlog::LogLevel::CRIT)
...
class NanoLogLine {
public:
  typedef std::tuple<bool, short, unsigned short, int, unsigned int,
                     unsigned long, long long, unsigned long long, float,
                     double, long double, long double, const char *>
      SupportedTypes;
...
struct Logger {
  Logger(nlog::NonGuaranteedLogger ngl, const char *path, const char *name,
    ...
    NLOG_INFO << "Non-guaranteed Logger starts.";
  }
  Logger(nlog::GuaranteedLogger gl, const char *path, const char *name,
    ...
    NLOG_INFO << "Guaranteed Logger starts.";
  }
  ~Logger() { NLOG_INFO << "Logger ends."; }
};
