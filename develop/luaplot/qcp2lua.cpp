...
struct AbstractPlottableHelper
{
    static int pixelsToCoords(lua_State* L)
    {
        ...
        QCPAbstractPlottable* o = luabridge::Stack<QCPAbstractPlottable*>::get(L, 1);
        lua_settop(L, 0);

        double key = 0.0, value = 0.0;
        o->pixelsToCoords(x, y, key, value);
    ...
    static int coordsToPixels(lua_State* L)
    {
        ...
        double x = 0, y = 0;
        o->coordsToPixels(key, value, x, y);
...
struct ColorMapDataHelper
{
    static int cellToCoord(lua_State* L)
    {
        ...
        QCPColorMapData* d = luabridge::Stack<QCPColorMapData*>::get(L, 1);
        lua_settop(L, 0);

        double key = 0.0, value = 0.0;
        d->cellToCoord(keyIndex, valueIndex, &key, &value);
    ...
    static int coordToCell(lua_State* L)
    {
        ...
        d->coordToCell(key, value, &keyIndex, &valueIndex);
      ...
      .beginNamespace(ns)
        ...
        .endClass()
          ...
          .deriveClass<QCPAbstractLegendItem, QCPLayoutElement>("AbstractLegendItem")
            .addFunction("font", &QCPAbstractLegendItem::font)
            .addFunction("parentLegend", &QCPAbstractLegendItem::parentLegend)
            .addFunction("setFont", &QCPAbstractLegendItem::setFont)
            .addFunction("setTextColor", &QCPAbstractLegendItem::setTextColor)
            .addFunction("textColor", &QCPAbstractLegendItem::textColor)
          .endClass()

          .deriveClass<QCPPlottableLegendItem, QCPAbstractLegendItem>("QCPPlottableLegendItem")
            .addFunction("plottable", &QCPPlottableLegendItem::plottable)
          .endClass()

          .deriveClass<QCPAxisRect, QCPLayoutElement>("AxisRect")
            .addFunction("axis", &QCPAxisRect::axis)
            .addFunction("axisCount", &QCPAxisRect::axisCount)
            .addFunction("axes", static_cast<QList<QCPAxis*>(QCPAxisRect::*)()const>(&QCPAxisRect::axes))
            .addFunction("axesByType", static_cast<QList<QCPAxis*>(QCPAxisRect::*)(QCPAxis::AxisTypes)const>(&QCPAxisRect::axes))
            .addFunction("addAxis", &QCPAxisRect::addAxis)
            .addFunction("addAxes", &QCPAxisRect::addAxes)
            .addFunction("background", &QCPAxisRect::background)
            .addFunction("backgroundBrush", &QCPAxisRect::backgroundBrush)
            .addFunction("backgroundScaled", &QCPAxisRect::backgroundScaled)
            .addFunction("backgroundScaledMode", &QCPAxisRect::backgroundScaledMode)
            .addFunction("bottom", &QCPAxisRect::bottom)
            .addFunction("bottomLeft", &QCPAxisRect::bottomLeft)
            .addFunction("bottomRight", &QCPAxisRect::bottomRight)
            .addFunction("center", &QCPAxisRect::center)
            .addFunction("elements", &QCPAxisRect::elements)
            .addFunction("graphs", &QCPAxisRect::graphs)
            .addFunction("height", &QCPAxisRect::height)
            .addFunction("insetLayout", &QCPAxisRect::insetLayout)
            .addFunction("items", &QCPAxisRect::items)
            .addFunction("left", &QCPAxisRect::left)
            .addFunction("plottables", &QCPAxisRect::plottables)
            .addFunction("rangeDrag", &QCPAxisRect::rangeDrag)
            .addFunction("rangeDragAxis", &QCPAxisRect::rangeDragAxis)
            .addFunction("rangeDragAxes", &QCPAxisRect::rangeDragAxes)
            .addFunction("rangeZoom", &QCPAxisRect::rangeZoom)
            .addFunction("rangeZoomAxis", &QCPAxisRect::rangeZoomAxis)
            .addFunction("rangeZoomAxes", &QCPAxisRect::rangeZoomAxes)
            .addFunction("rangeZoomFactor", &QCPAxisRect::rangeZoomFactor)
            .addFunction("right", &QCPAxisRect::right)
            .addFunction("removeAxis", &QCPAxisRect::removeAxis)
            .addFunction("setBackgroundByPixmap", static_cast<void(QCPAxisRect::*)(const QPixmap&)>(&QCPAxisRect::setBackground))
            .addFunction("setBackgroundByPixmapAndScaled", static_cast<void(QCPAxisRect::*)(const QPixmap&, bool, Qt::AspectRatioMode)>(&QCPAxisRect::setBackground))
            .addFunction("setBackgroundByBrush", static_cast<void(QCPAxisRect::*)(const QBrush&)>(&QCPAxisRect::setBackground))
            .addFunction("setBackgroundScaled", &QCPAxisRect::setBackgroundScaled)
            .addFunction("setBackgroundScaledMode", &QCPAxisRect::setBackgroundScaledMode)
            ...
            .addFunction("setRangeDrag", &QCPAxisRect::setRangeDrag)
            .addFunction("setRangeDragAxes", static_cast<void(QCPAxisRect::*)(QCPAxis*, QCPAxis*)>(&QCPAxisRect::setRangeDragAxes))
            .addFunction("setRangeDragAxesList", static_cast<void(QCPAxisRect::*)(QList<QCPAxis*>)>(&QCPAxisRect::setRangeDragAxes))
            .addFunction("setRangeDragAxesList2", static_cast<void(QCPAxisRect::*)(QList<QCPAxis*>, QList<QCPAxis*>)>(&QCPAxisRect::setRangeDragAxes))
            .addFunction("setRangeZoom", &QCPAxisRect::setRangeZoom)
            .addFunction("setRangeZoomAxes", static_cast<void(QCPAxisRect::*)(QCPAxis*, QCPAxis*)>(&QCPAxisRect::setRangeZoomAxes))
            .addFunction("setRangeZoomAxesList", static_cast<void(QCPAxisRect::*)(QList<QCPAxis*>)>(&QCPAxisRect::setRangeZoomAxes))
            .addFunction("setRangeZoomAxesList2", static_cast<void(QCPAxisRect::*)(QList<QCPAxis*>, QList<QCPAxis*>)>(&QCPAxisRect::setRangeZoomAxes))
            .addFunction("setRangeZoomFactor", static_cast<void(QCPAxisRect::*)(double)>(&QCPAxisRect::setRangeZoomFactor))
            .addFunction("setRangeZoomFactor2", static_cast<void(QCPAxisRect::*)(double, double)>(&QCPAxisRect::setRangeZoomFactor))
            .addFunction("setupFullAxesBox", &QCPAxisRect::setupFullAxesBox)
            .addFunction("size", &QCPAxisRect::size)
            .addFunction("top", &QCPAxisRect::top)
            .addFunction("topLeft", &QCPAxisRect::topLeft)
            .addFunction("topRight", &QCPAxisRect::topRight)
            .addFunction("width", &QCPAxisRect::width)
            .addFunction("zoom", static_cast<void(QCPAxisRect::*)(const QRectF&)>(&QCPAxisRect::zoom))
//            .addFunction("zoom", static_cast<void(QCPAxisRect::*)(const QRectF&, const QList<QCPAxis*>&)>(&QCPAxisRect::zoom))
          .endClass()

          .deriveClass<QCPColorScale, QCPLayoutElement>("ColorScale")
            .addFunction("axis", &QCPColorScale::axis)
            .addFunction("barWidth", &QCPColorScale::barWidth)
            .addFunction("colorMaps", &QCPColorScale::colorMaps)
            .addFunction("dataRange", &QCPColorScale::dataRange)
            .addFunction("dataScaleType", &QCPColorScale::dataScaleType)
            .addFunction("gradient", &QCPColorScale::gradient)
            .addFunction("label", &QCPColorScale::label)
            .addFunction("rangeDrag", &QCPColorScale::rangeDrag)
            .addFunction("rangeZoom", &QCPColorScale::rangeZoom)
            .addFunction("rescaleDataRange", &QCPColorScale::rescaleDataRange)
            .addFunction("setBarWidth", &QCPColorScale::setBarWidth)
            .addFunction("setDataRange", &QCPColorScale::setDataRange)
            .addFunction("setDataScaleType", &QCPColorScale::setDataScaleType)
            .addFunction("setGradient", &QCPColorScale::setGradient)
            .addFunction("setLabel", &QCPColorScale::setLabel)
            .addFunction("setRangeDrag", &QCPColorScale::setRangeDrag)
            .addFunction("setRangeZoom", &QCPColorScale::setRangeZoom)
            .addFunction("setType", &QCPColorScale::setType)
            .addFunction("type", &QCPColorScale::type)
            .addFunction("update", &QCPColorScale::update)
          .endClass()

          .deriveClass<QCPLayout, QCPLayoutElement>("Layout")
            .addFunction("clear", &QCPLayoutGrid::clear)
            .addFunction("elementAt", &QCPLayoutGrid::elementAt)
            .addFunction("elementCount", &QCPLayoutGrid::elementCount)
            .addFunction("elements", &QCPLayoutGrid::elements)
            .addFunction("removeAt", &QCPLayoutGrid::removeAt)
            .addFunction("simplify", &QCPLayoutGrid::simplify)
            .addFunction("take", &QCPLayoutGrid::take)
            .addFunction("takeAt", &QCPLayoutGrid::takeAt)
            .addFunction("update", &QCPLayoutGrid::update)
          .endClass()
            ...
            .deriveClass<QCPLayoutGrid, QCPLayout>("LayoutGrid")
              ...
              .addFunction("addElement2", static_cast<bool (QCPLayoutGrid::*)(QCPLayoutElement*)>(&QCPLayoutGrid::addElement))
              .addFunction("rowCount", &QCPLayoutGrid::rowCount)
              .addFunction("columnCount", &QCPLayoutGrid::columnCount)
              .addFunction("element", &QCPLayoutGrid::element)
              .addFunction("elementAt", &QCPLayoutGrid::elementAt)
              .addFunction("elementCount", &QCPLayoutGrid::elementCount)
              .addFunction("elements", &QCPLayoutGrid::elements)
              .addFunction("expandTo", &QCPLayoutGrid::expandTo)
              .addFunction("hasElement", &QCPLayoutGrid::hasElement)
              .addFunction("insertColumn", &QCPLayoutGrid::insertColumn)
              .addFunction("insertRow", &QCPLayoutGrid::insertRow)
//              .addFunction("indexToRowCol", &QCPLayoutGrid::indexToRowCol)
              .addFunction("rowColToIndex", &QCPLayoutGrid::rowColToIndex)
              .addFunction("minimumOuterSizeHint", &QCPLayoutGrid::minimumOuterSizeHint)
              .addFunction("maximumOuterSizeHint", &QCPLayoutGrid::maximumOuterSizeHint)
              .addFunction("setColumnSpacing", &QCPLayoutGrid::setColumnSpacing)
              .addFunction("setColumnStretchFactor", &QCPLayoutGrid::setColumnStretchFactor)
              .addFunction("setColumnStretchFactors", &QCPLayoutGrid::setColumnStretchFactors)
              .addFunction("setFillOrder", &QCPLayoutGrid::setFillOrder)
              .addFunction("setRowSpacing", &QCPLayoutGrid::setRowSpacing)
              .addFunction("setRowStretchFactor", &QCPLayoutGrid::setRowStretchFactor)
              .addFunction("setRowStretchFactors", &QCPLayoutGrid::setRowStretchFactors)
              .addFunction("setRowSpacing", &QCPLayoutGrid::setRowSpacing)
              .addFunction("setWrap", &QCPLayoutGrid::setWrap)
              .addFunction("simplify", &QCPLayoutGrid::simplify)
              .addFunction("take", &QCPLayoutGrid::take)
              .addFunction("takeAt", &QCPLayoutGrid::takeAt)
              .addFunction("updateLayout", &QCPLayoutGrid::updateLayout)
            .endClass()

              .deriveClass<QCPLegend, QCPLayoutGrid>("Legend")
                .addFunction("addItem", &QCPLegend::addItem)
                .addFunction("borderPen", &QCPLegend::borderPen)
                .addFunction("brush", &QCPLegend::brush)
                .addFunction("clearItems", &QCPLegend::clearItems)
                .addFunction("font", &QCPLegend::font)
                .addFunction("hasItem", &QCPLegend::hasItem)
                .addFunction("hasItemWithPlottable", &QCPLegend::hasItemWithPlottable)
                .addFunction("iconBorderPen", &QCPLegend::iconBorderPen)
                .addFunction("iconSize", &QCPLegend::iconSize)
                .addFunction("iconTextPadding", &QCPLegend::iconTextPadding)
                .addFunction("item", &QCPLegend::item)
                .addFunction("itemCount", &QCPLegend::itemCount)
                .addFunction("itemWithPlottable", &QCPLegend::itemWithPlottable)
                ...
                .addFunction("setIconBorderPen", &QCPLegend::setIconBorderPen)
                .addFunction("setIconSize", static_cast<void(QCPLegend::*)(const QSize&)>(&QCPLegend::setIconSize))
                .addFunction("setIconSizeXY", static_cast<void(QCPLegend::*)(int, int)>(&QCPLegend::setIconSize))
                .addFunction("setIconTextPadding", &QCPLegend::setIconTextPadding)
                .addFunction("setTextColor", &QCPLegend::setTextColor)
              .endClass()

            .deriveClass<QCPLayoutInset, QCPLayout>("LayoutInset")
              .addFunction("setInsetAlignment", &QCPLayoutInset::setInsetAlignment)
              .addFunction("insetPlacement", &QCPLayoutInset::insetPlacement)
              .addFunction("insetAlignment", &QCPLayoutInset::insetAlignment)
              .addFunction("insetRect", &QCPLayoutInset::insetRect)
              .addFunction("setInsetPlacement", &QCPLayoutInset::setInsetPlacement)
              .addFunction("setInsetRect", &QCPLayoutInset::setInsetRect)
              .addFunction("updateLayout", &QCPLayoutInset::updateLayout)
              .addFunction("elementCount", &QCPLayoutInset::elementCount)
              .addFunction("elementAt", &QCPLayoutInset::elementAt)
              .addFunction("takeAt", &QCPLayoutInset::takeAt)
              .addFunction("take", &QCPLayoutInset::take)
              .addFunction("simplify", &QCPLayoutInset::simplify)
            .endClass()

          .deriveClass<QCPTextElement, QCPLayoutElement>("TextElement")
            .addFunction("font", &QCPTextElement::font)
            .addFunction("setFont", &QCPTextElement::setFont)
            .addFunction("setText", &QCPTextElement::setText)
            .addFunction("setTextColor", &QCPTextElement::setTextColor)
            .addFunction("setTextFlags", &QCPTextElement::setTextFlags)
            .addFunction("text", &QCPTextElement::text)
            .addFunction("textColor", &QCPTextElement::textColor)
            .addFunction("textFlags", &QCPTextElement::textFlags)
          .endClass()
...
static void QcpPlot2Lua(lua_State* L, const char* ns)
{
    luabridge::getGlobalNamespace(L)
      .beginNamespace(ns)
        ...
        .endClass()
          ...
          .deriveClass<LuaPlot, QCustomPlot>("LuaPlot")
            ...
            .addFunction("createAxisRect", &LuaPlot::createInstance<QCPAxisRect, QCustomPlot*, bool>)
            .addFunction("createColorMap", &LuaPlot::createInstance<QCPColorMap, QCPAxis*, QCPAxis*>)
            .addFunction("createColorScale", &LuaPlot::createInstance<QCPColorScale, QCustomPlot*>)
            .addFunction("createAxisTickerFixed", &LuaPlot::createInstance<QCPAxisTickerFixed>)
            .addFunction("createAxisTickerDateTime", &LuaPlot::createInstance<QCPAxisTickerDateTime>)
            .addFunction("createAxisTickerLog", &LuaPlot::createInstance<QCPAxisTickerLog>)
            .addFunction("createAxisTickerPi", &LuaPlot::createInstance<QCPAxisTickerPi>)
            .addFunction("createAxisTickerText", &LuaPlot::createInstance<QCPAxisTickerText>)
            .addFunction("createAxisTickerTime", &LuaPlot::createInstance<QCPAxisTickerTime>)
            .addFunction("createBars", &LuaPlot::createInstance<QCPBars, QCPAxis*, QCPAxis*>)
            .addFunction("createErrorBars", &LuaPlot::createInstance<QCPErrorBars, QCPAxis*, QCPAxis*>)
            .addFunction("createLayoutGrid", &LuaPlot::createInstance<QCPLayoutGrid>)
            .addFunction("createMarginGroup", &LuaPlot::createInstance<QCPMarginGroup, QCustomPlot*>)
            .addFunction("createGraphDataContainer", &LuaPlot::createWithSharedPointer<QCPGraphDataContainer>)
            .addFunction("createFinancial", &LuaPlot::createInstance<QCPFinancial, QCPAxis*, QCPAxis*>)
            .addFunction("createCurve", &LuaPlot::createInstance<QCPCurve, QCPAxis*, QCPAxis*>)
            .addFunction("createItemTracer", &LuaPlot::createInstance<QCPItemTracer, QCustomPlot*>)
            .addFunction("createItemCurve", &LuaPlot::createInstance<QCPItemCurve, QCustomPlot*>)
            .addFunction("createItemText", &LuaPlot::createInstance<QCPItemText, QCustomPlot*>)
            .addFunction("createItemBracket", &LuaPlot::createInstance<QCPItemBracket, QCustomPlot*>)
            .addFunction("createItemLine", &LuaPlot::createInstance<QCPItemLine, QCustomPlot*>)
            .addFunction("createStatisticalBox", &LuaPlot::createInstance<QCPStatisticalBox, QCPAxis*, QCPAxis*>)
            .addFunction("createTextElement", &LuaPlot::createInstance<QCPTextElement, QCustomPlot*>)
...
void Qcp2Lua(lua_State* L, const char* ns)
{
    QcpBasic2Lua(L, ns);
