...
local function fp(plot)
  ...
  wideAxisRect:addAxis(qcp.Axis.atLeft, nil):setTickLabelColor(luaplot.QColor.fromString("#6050F8"))
  ...
  local st1 = luaplot.ScatterStyle.fromShapePenBrushAndSize(qcp.ScatterStyle.ssCircle, luaplot.QPen.fromColor(luaplot.QColor.fromGlobal(qt.black)), luaplot.QBrush.fromColor(luaplot.QColor.fromGlobal(qt.white), qt.SolidPattern), 6.0)
  mainGraphCos:setScatterStyle(st1)
  local p1 = luaplot.QPen.fromColor(luaplot.QColor.fromRGB(120, 120, 120, 255))
  p1:setWidthF(2.0)
  ...
  p1 = luaplot.QPen.fromColor(luaplot.QColor.fromString("#8070B8"))
  p1:setWidthF(2.0)
  mainGraphGauss:setPen(p1)

  local b1 = luaplot.QBrush.fromColor(luaplot.QColor.fromRGB(110, 170, 110, 30), qt.SolidPattern)
  mainGraphGauss:setBrush(b1)
  mainGraphCos:setChannelFillGraph(mainGraphGauss)
  b1 = luaplot.QBrush.fromColor(luaplot.QColor.fromRGB(255, 161, 0, 50), qt.SolidPattern)
  ...
  local p1 = luaplot.QPen.fromColor(luaplot.QColor.fromString("#FFA100"))
  p1:setWidthF(1.5)
  ...
  local c1 = luaplot.QColor.fromGlobal(qt.black)
  subBars:setPen(luaplot.QPen.fromColor(c1))
  subBars:setAntialiased(false)
  subBars:setAntialiasedFill(false)
  c1 = luaplot.QColor.fromString("#705BE8")
  subBars:setBrush(luaplot.QBrush.fromColor(c1, qt.SolidPattern))
