...
local function fp(plot)
  ...
  candlesticks:setBrushPositive(luaplot.QBrush.fromColor(luaplot.QColor.fromRGB(245, 245, 245, 255), qt.SolidPattern))
  candlesticks:setBrushNegative(luaplot.QBrush.fromColor(luaplot.QColor.fromRGB(40, 40, 40, 255), qt.SolidPattern))
  candlesticks:setPenPositive(luaplot.QPen.fromColor(luaplot.QColor.fromRGB(0, 0, 0, 255)))
  candlesticks:setPenNegative(luaplot.QPen.fromColor(luaplot.QColor.fromRGB(0, 0, 0, 255)))
  ...
  volumeAxisRect:setMargins(luaplot.QMargins.from(0, 0, 0, 0))
  ...
  volumePos:setPen(luaplot.QPen.fromStyle(qt.NoPen))
  volumePos:setBrush(luaplot.QBrush.fromColor(luaplot.QColor.fromRGB(100, 180, 110, 255), qt.SolidPattern))
  volumeNeg:setWidth(3600*4);
  volumeNeg:setPen(luaplot.QPen.fromStyle(qt.NoPen))
  volumeNeg:setBrush(luaplot.QBrush.fromColor(luaplot.QColor.fromRGB(180, 90, 90, 255), qt.SolidPattern))
  ...
  plot.xAxis:setBasePen(luaplot.QPen.fromStyle(qt.NoPen))
